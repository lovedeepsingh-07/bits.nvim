local fs = require("bits.dired.fs")
local ls = require("bits.dired.ls")
local display = require("bits.dired.display")
local highlight = require("bits.dired.highlight")
local config = require("bits.dired.config")
local funcs = require("bits.dired.functions")
local utils = require("bits.dired.utils")
local marker = require("bits.dired.marker")
local history = require("bits.dired.history")
local clipboard = require("bits.dired.clipboard")
...
-- execute shell command in the current dired path
function M.shell_cmd_curr_path()
